...
2. Clone the repo
   ```sh
   git clone https://github.com/github_username/adsct.git
   ```
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin github_username/adsct
...
<a href="https://github.com/github_username/adsct/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=github_username/adsct" alt="contrib.rocks image" />
</a>
...
Project Link: [https://github.com/github_username/adsct](https://github.com/github_username/adsct)
